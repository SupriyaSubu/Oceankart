...
<html lang="en">
<head>
<title>Oceankart</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Little Closet template">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>
	assets/css/bootstrap-4.1.2/bootstrap.min.css">
	...
	<header class="header">
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
				...
				<!-- Cart -->
				<div class="cart"><a href="<?php echo base_url(); ?>CusRegister/gocart"><div><img class="svg" src="<?php echo base_url(); ?>assets/images/cart.svg" alt="https://www.flaticon.com/authors/freepik"></div></a></div>
				<!-- Phone -->
		...
		<div class="home">
			...
			<div class="home_slider_container">
				<div class="owl-carousel owl-theme home_slider">
					...
					<!-- Slide -->
					<div class="owl-item">
						<div class="background_image" style="background-image:url(<?php echo base_url(); ?>assets/images/home.jpg)"></div>
											...
											<div class="home_items">
												<div class="row">
													<div class="col-sm-3 offset-lg-1">
														<div class="home_item_side"><a href="product.php"><img src="<?php echo base_url(); ?>assets/images/home_1.jpg" alt=""></a></div>
													</div>
													<div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
														<div class="product home_item_large">
															...
															<div class="product_image"><img src="<?php echo base_url(); ?>assets/images/home_2.jpg" alt=""></div>
																...
																<div class="product_buttons">
																	<div class="text-right d-flex flex-row align-items-start justify-content-start">
																		<div class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">
																			<div><div><img src="<?php echo base_url(); ?>assets/images/heart.svg" alt=""><div>+</div></div></div>
																		</div>
																		<div class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
																			<div><div><img src="<?php echo base_url(); ?>assets/images/cart_2.svg" alt=""><div>+</div></div></div>
																		</div>
																	</div>
																</div>
															</div>
													...
													<div class="col-sm-3">
														<div class="home_item_side"><a href="product.php"><img src="<?php echo base_url(); ?>assets/images/home_3.jpg" alt=""></a></div>
													</div>
												</div>
											</div>
										</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 offset-lg-3">
						<div class="section_title text-center">Popular on Oceankart</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col">
						<div class="boxes_container d-flex flex-row align-items-start justify-content-between flex-wrap">
							...
							<!-- Box -->
							<div class="box">
								<div class="background_image" style="background-image:url(<?php echo base_url(); ?>assets/images/box_1.jpg)"></div>
								<div class="box_content d-flex flex-row align-items-center justify-content-start">
									<div class="box_left">
										<div class="box_image">
											<a href="<?php echo base_url(); ?>CusRegister/gocateg">
												<div class="background_image" style="background-image:url(<?php echo base_url(); ?>assets/images/box_1_img.jpg)"></div>
											</a>
										</div>
									</div>
							...
							<!-- Box -->
							<div class="box">
								<div class="background_image" style="background-image:url(<?php echo base_url(); ?>assets/images/box_2.jpg)"></div>
								<div class="box_content d-flex flex-row align-items-center justify-content-start">
									<div class="box_left">
										<div class="box_image">
											<a href="<?php echo base_url(); ?>CusRegister/gocateg">
												<div class="background_image" style="background-image:url(<?php echo base_url(); ?>assets/images/box_2_img.jpg)"></div>
											</a>
										</div>
									</div>
									<div class="box_right text-center">
							...
							<!-- Box -->
							<div class="box">
								<div class="background_image" style="background-image:url(<?php echo base_url(); ?>assets/images/box_3.jpg)"></div>
								<div class="box_content d-flex flex-row align-items-center justify-content-start">
									<div class="box_left">
										<div class="box_image">
											<a href="<?php echo base_url(); ?>CusRegister/gocateg">
												<div class="background_image" style="background-image:url(<?php echo base_url(); ?>assets/images/box_3_img.jpg)"></div>
											</a>
										</div>
									</div>
									<div class="box_right text-center">
										<div class="box_title">Top Collection
										</div>
									</div>
								</div>
							</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 feature_col">
						<div class="feature d-flex flex-row align-items-start justify-content-start">
							<div class="feature_left">
								<div class="feature_icon"><img src="<?php echo base_url(); ?>assets/images/icon_1.svg" alt=""></div>
							</div>
					...
					<div class="col-lg-4 feature_col">
						<div class="feature d-flex flex-row align-items-start justify-content-start">
							<div class="feature_left">
								<div class="feature_icon ml-auto mr-auto"><img src="<?php echo base_url(); ?>assets/images/icon_2.svg" alt=""></div>
							</div>
							<div class="feature_right d-flex flex-column align-items-start justify-content-center">
					...
					<div class="col-lg-4 feature_col">
						<div class="feature d-flex flex-row align-items-start justify-content-start">
							<div class="feature_left">
								<div class="feature_icon"><img src="<?php echo base_url(); ?>assets/images/icon_3.svg" alt=""></div>
							</div>
							<div class="feature_right d-flex flex-column align-items-start justify-content-center">
