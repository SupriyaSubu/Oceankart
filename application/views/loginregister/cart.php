...
<link href="<?php echo base_url(); ?>plugins/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" 
	type="text/css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/cart.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/cart_responsive.css">
</head>
<body>
	...
	<header class="header">
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
				...
				<!-- Cart -->
				<div class="cart"><a href="<?php echo base_url(); ?>CusRegister/gocart"><div><img src="<?php echo base_url(); ?>assets/images/cart.svg" alt="https://www.flaticon.com/authors/freepik"></div></a></div>
				<!-- Phone -->
						...
						<div class="cart_container">
								...
								<ul class="cart_items_list">
									...
									<li class="cart_item item_list d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-end justify-content-start">
										<div class="product d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start mr-auto">
											...
											<div><div class="product_image"><img src="<?php echo base_url(); ?>assets/images/cart_item_1.jpg" alt=""></div></div>
							...
							<div class="cart_buttons d-flex flex-row align-items-start justify-content-start">
								<div class="cart_buttons_inner ml-sm-auto d-flex flex-row align-items-start justify-content-start flex-wrap">
									<div class="button button_clear trans_200"><a href="categories.php">clear cart</a></div>
									<div class="button button_continue trans_200"><a href="<?php echo base_url(); ?>CusRegister/gocateg">continue shopping</a></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row cart_extra_row">
					...
					<div class="col-lg-6 cart_extra_col">
						<div class="cart_extra cart_extra_2">
							<div class="cart_extra_content cart_extra_total" style="left: 200px; width: 755px;height: 652px;top: 20px; bottom: 150px;
">
								...
								<div class="checkout_button trans_200"><a href="<?php echo base_url(); ?>CusRegister/gocheckout">proceed to checkout</a></div>
							</div>
						</div>
					</div>
				</div>
